# Generated by Django 2.2 on 2021-08-06 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', jsonfield.fields.JSONField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Requests',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zoominfo', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('status', models.BooleanField(default=True)),
                ('phone', models.CharField(blank=True, default='', max_length=80, null=True)),
                ('picture', models.TextField(blank=True, default='', null=True)),
                ('files', models.CharField(default='', max_length=100)),
